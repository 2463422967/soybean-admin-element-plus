const local: App.I18n.Schema = {
  ...
  route: {
    ...
    'basic-manage_label-design': '标签管理',
    'basic-manage_label-management': '标签打印',
    'basic-manage_location-management': '库位管理',
    'basic-manage_material-management': '物料管理',
    'basic-manage_personnel-management': '人员管理',
    'basic-manage_role-management': '角色管理',
    'basic-manage_shelf-management': '货架管理',
    'basic-manage_warehouse-management': '仓库管理',
    'inbound-manage': '入库管理',
    'inbound-manage_inbound-operation': '入库作业',
    'inbound-manage_procurement-receiving': '收货作业',
    'inbound-manage_putaway-operation': '上架作业',
    'internal-manage': '库内管理',
    'internal-manage_location-movement': '仓位移动作业',
    'internal-manage_warehouse-transfer': '仓库调拨作业',
    'inventory-manage': '库存管理',
    'outbound-manage': '出库管理',
    'outbound-manage_sales-outbound': '拣货作业',
    'report-analyze': '报表分析',
    'report-analyze_inventory-report': '库存报表',
    'report-analyze_operation-report': '作业报表',
    'report-analyze_total-report': '仓储综合看板',
    ...
    manage_role: '角色管理',
    manage_menu: '菜单管理',
    'manage_document-source-setting': '单据参数设置',
    'multi-menu': '多级菜单',
